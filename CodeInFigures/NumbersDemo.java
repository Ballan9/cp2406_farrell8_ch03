...
public class NumbersDemo
    {
        ...
        public static int displayTwiceTheNumber(Integer number1, number2);
            number1By2 = number1 * 2;
            number2By2 = number2 * 2;
            JOptionPane.ShowOutputDialog(null, "Your first number squared is: " + numberBy2 + " Your second number squared is: " + number2By1 );
